...
pip install hf_transfer "huggingface_hub[cli]" --quiet
...
git clone https://github.com/Lightricks/ComfyUI-LTXVideo --quiet || true
git clone https://github.com/kijai/ComfyUI-KJNodes --quiet || true
git clone https://github.com/rgthree/rgthree-comfy --quiet || true
git clone https://github.com/city96/ComfyUI-GGUF --quiet || true
git clone https://github.com/Kosinkadink/ComfyUI-VideoHelperSuite --quiet || true
git clone https://github.com/yolain/ComfyUI-Easy-Use --quiet || true

for dir in /workspace/ComfyUI/custom_nodes/*/; do
    [ -f "$dir/requirements.txt" ] && pip install -r "$dir/requirements.txt" --quiet || true
done
